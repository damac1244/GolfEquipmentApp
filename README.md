...
**Status: working backend, no frontend.** The ingest pipeline, product matcher
and read API are written and the matcher is tested. The UI is being designed
separately — the API exists to give it something to hit.
